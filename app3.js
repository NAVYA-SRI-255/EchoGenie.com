...
function takeCommand(message) {
    ...
    }else  if (message.includes("share me a recipe")) {
    ...
    } else if (message.includes("book tirumala tickets") || message.includes("tirumala darshan tickets")) {
    ...
    } else if (message.includes("book a train ticket")|| message.includes("open railway reservation system")) {
            openWebsite("https://www.irctc.co.in", "Redirecting to IRCTC for train booking...");
    } else if (message.includes("find tourist places near me") || message.includes("tourist attractions nearby") || message.includes("nearby travel destinations")) {
        findTouristPlaces();
